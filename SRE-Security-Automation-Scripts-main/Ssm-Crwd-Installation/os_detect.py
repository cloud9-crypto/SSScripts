    ...
    try:
        ...
        if output:
            ...
            if p.returncode == 0:
                ...
                cmd_start_amz = ['sudo', 'start', 'amazon-ssm-agent']
                p = subprocess.Popen(cmd_enable)
                p.wait()
                p = subprocess.Popen(cmd_start)
                p.wait()
                p = subprocess.Popen(cmd_start_amz)
                '''
            else:
    ...
    try:
        ...
        if output:
            ...
            if p.returncode == 0:
                ...
                p = subprocess.Popen(cmd_register, stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
                p.wait()
                p = subprocess.Popen(cmd_enable, stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
                p.wait()
                p = subprocess.Popen(cmd_start, stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
                p.wait()
                if p.returncode != 0:
                    p = subprocess.Popen(cmd_amz1_start, stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
                    p.wait()
                    p = subprocess.Popen(cmd_amz1_enable, stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
                    p.wait()
