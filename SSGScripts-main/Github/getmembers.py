...
def getmembers():
    url = "https://api.github.com/orgs/massmutual/members?per_page=100"
...
def exporttoexcel(array):
    ...
    csv_file = "/Users/mm67226/OneDrive - MassMutual/Scripts/SoftwareSecurity/SSGScripts/Github/members.csv"
    try:
